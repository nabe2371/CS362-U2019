...
public class UrlValidator implements Serializable {
    ...
    // Bug #1 (for Unit Test): Changed Alnum to Alpha
    private static final String AUTHORITY_CHARS_REGEX = "\\p{Alpha}\\-\\."; // allows for IPV4 but not IPV6
    ...
    // Bug #2 (for Unit Tests): Change + (one or more) sign to * (zero or more) sign
    ...
    public boolean isValid(String value) {
        ...
        //Bug #3 (for Random Tests): Now it returns false if the query part is valid.           
